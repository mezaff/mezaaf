                ...
                <table class="cart-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="shopping-cart__subtotal">{{ formatRupiah($item->subTotal())
                                    }}</span>
                            </td>
                            <td>
                    ...
                    <div class="shopping-cart__totals">
                        ...
                        <table class="cart-totals">
                            <tbody>
                                <tr>
                                    <th>Subtotal</th>
                                    <td>{{ formatRupiah(Cart::instance('cart')->subtotal()) }}</td>
                                </tr>
                                <tr>
                        ...
                        <table class="cart-totals">
                            <tbody>
                                ...
                                <tr>
                                    <th>VAT</th>
                                    <td>{{ formatRupiah(Cart::instance('cart')->tax()) }}</td>
                                </tr>
                                <tr>
                                    <th>Total</th>
                                    <td>{{ formatRupiah(Cart::instance('cart')->total()) }}</td>
                                </tr>
                            </tbody>
                        </table>
                        @endif
